...
express()
  ...
  .get('/', (req, res) => res.render('pages/index', {}))
	.get('/submit-translate', function(request,response){
			...
			translate(query, {from: from, to: to}).then(res => {
			    ...
			    var didYouMean = res.from.text.didYouMean;
					...
					response.render('pages/index', {initialText: initialText, translatedText: translatedText, isTranslated: isTranslated, autoCorrected: autoCorrected, correctedText: correctedText, didYouMean:didYouMean})
